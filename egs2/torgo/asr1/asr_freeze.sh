...
# ASR model related
asr_tag=freeze_encoder_transfer_conv2d       # Suffix to the result dir for asr model training.
...
freeze_param="encoder.enc encoder.decoder"
init_param=./exp/pretrained/54epoch.pth
download_model=
#download_model=Shinji-Watanabe/librispeech_asr_train_asr_transformer_e18_raw_bpe_sp_valid.acc.best # Download a model from Model Zoo and use it for decoding.
